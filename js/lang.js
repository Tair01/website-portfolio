const langArr = {
    ...
    "title-3-3-text3bis1": {
        ...
        "ru": "Я также работал преподавателем французского языка для начинающих (уровень А1).Ссылка на видео о",
    },
    "title-3-3-text3bis2": {
        "en": "French courses",
    ...
    "title-4-4-text4": {
        ...
        "ru": "Я побывал в более чем семи странах и жил в двух разных. Моя первая поездка во Францию ​​в 2009 году ознаменовала начало моего международного путешествия, где я учился в детском саду, в начальной школе, а затем в колледже. В свободное время я увлекаюсь горными лыжами, настольным теннисом и футболом. Я также глубоко увлечен литературой и постоянным самообразованием.",
    },
};
